classdef DescramblerHDMI < handle
    ...
    methods
        function obj = DescramblerHDMI(seed)
            if(nargin == 0)
        ...
        function o = descramble(obj, signalToDescramble)
            for i = 1:signalToDescramble.getSize()
                ...
                x = xor(obj.LFSR(1,1), xor(obj.LFSR(1,12), xor(obj.LFSR(1,13), xor(obj.LFSR(1,14), obj.LFSR(1,17)))));
                x = xor(insertBit, x);
